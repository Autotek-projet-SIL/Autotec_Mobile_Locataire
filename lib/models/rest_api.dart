...
//use this function to create a user
  ...
  static Future<http.Response> editLocationState(String etat, String id) async {

    return await http.put(
      Uri.parse('https://autotek-server.herokuapp.com/gestionlocations/update_suivi_location/${id}'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
      body: jsonEncode(<String, String> {
